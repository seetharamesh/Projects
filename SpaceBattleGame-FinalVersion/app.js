...
/* Begin -- Javascript for SpaceBattle begins*/
...
$("#startGame").click(function() {
  ...
  class User {
    ...
    introduceYourself() {
      ...
      console.log("%c Hello " + this.userName + "!! You are going to battle against " + this.numberOfAliens + " alien(s) today. All the Best!", "color:blue;font-size:20px");
    }
